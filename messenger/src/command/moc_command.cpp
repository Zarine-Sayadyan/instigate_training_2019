/****************************************************************************
** Meta object code from reading C++ file 'command.hpp'
**
...
#error "The header file 'command.hpp' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject messenger_server::command::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_messenger_server__command.data,
    qt_meta_data_messenger_server__command,
    qt_static_metacall,
    nullptr,
    nullptr
} };
